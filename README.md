...
The peer dependencies are pinned exactly — install `mcp-use@2.1.0`, `@modelcontextprotocol/sdk@1.30.0`, and `zod@4.4.3` alongside (see each package's `peerDependencies` for the authoritative list).
