...
This release moves the toolkit from mcp-use **1.34** to **2.0.4** and onto
...
- [ ] Bump `mcp-use` to `2.0.4`, `@modelcontextprotocol/sdk` to `1.30.0`; Node `>=22.22.2`.
